...
public class GetMessage {
     ...
     * 用户ID
     */
    public static final String ACCOUNT_SID = "dafebf4326ca49f7911e55804a9bac7d";//这里填写你在平台里的ACOUNT_SID

    /**
     * 密钥
     */
    public static final String AUTH_TOKEN = "6d4ff39cd75b48d1b20f50c9bb110ec5";
    ...
    public  static String smsContent = "【微妆科技】您的验证码为"+randNum+"，请于"+2+"分钟内正确输入，如非本人操作，请忽略此短信。";
    /**
     * (获取短信验证码)
     * @param to
     * @return String
    ...
    public static String getResult(String to) {
        ...
        String smsContent = "【微妆科技】您的验证码为"+randNum+"，请于"+2+"分钟内正确输入，如非本人操作，请忽略此短信。";            //这里的randNum 和 smsContent和上面的静态变量是一样的，可删除可保留
