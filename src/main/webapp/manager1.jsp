		...
		<main id="main-content" role="main">
			<div class="container">
				...
				<form action="#" method="get">
						...
						<div style="width:800px;height:800px;margin-left:350px;">
				    ...
				    <div style="width:400px;height:800px;float:left">
						...
						<div class="form-group">
    						...
    						<tr colspan="3">
    						<td>姓名&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
    						<td>用户id &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
    						<td>登录名</td>
    						</tr>
    						
    						<c:forEach items="${managerlist}" >
    						<tr>
    						<td>${managerlist.man_name}</td>
    						<td>${managerlist.man_id}</td>
    						<td>${managerlist.man_loginname}</td> 
    						</tr>   						
    						</c:forEach>
  						...
  						<div class="checkbox">
				    	    ...
				    	    <div style="width:400px;height:800px;margin-left:400px;position:relative">
						<header class="side-section-header">
					...
					<div class="form-group">
    						<table border="1">
    						<tr colspan="3">
    						<td>姓名&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
    						<td>用户id &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
    						<td>登录名</td>
    						</tr>
