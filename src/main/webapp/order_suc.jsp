								...
								<div id="sub-cart" class="sub-header">
									...
									<div class="cart-footer">
										<div class="cart-total clearfix">
											<span class="pull-left uppercase">总价</span>
				...
				<div class="main-header">
					...
					<nav id="site-menu" role="navigation">
						<ul class="main-menu hidden-sm hidden-xs">
							...
							<li>
								<a href="products.jsp">商城</a>
							</li>
							<li>
								<a href="note.jsp">笔记</a>
							</li>
							<li>
...
<div class="back">
	...
	<div class="container"> 
	  ...
	  <div class="box_4">
        ...
        <br><br><br><br><br><br>
        <div class="bottom"><br>
        		<a href="#" class="btn btn-primary btn-round uppercase">支付</a>&nbsp;&nbsp;&nbsp;
								...
								<div class="widget-content">
									<ul class="menu iconed-list unstyled">
										<li>
											...
											<div class="list-content">陕西省杨凌区西北农林科技大学北校区信息工程学院</div>
										</li>
										<li>
											<span class="list-icon"><i class="round-icon iconfont-phone"></i></span>
											<div class="list-content">+86 （100）0000</div>
										</li>
										<li>
				...
				<div class="row">
					<div class="col-xs-12 col-sm-6">
						...
						<div class="copyright center-xs">
							<p>© 2013 More Templates <a href="home.html" target="_blank" title="微妆科技">微妆科技</a> - Collect from <a href="home.html" title="微妆科技有限公司" target="_blank">微妆科技有限公司</a>. All Rights Reserved.</p>
						</div>
					</div>
