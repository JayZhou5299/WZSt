			...
			<div class="row">
				...
				<div class="m-t-b clearfix">
								...
								<div class="side-section-content">
									...
									<form action="manager/exit.do" method="get">
										...
										<div class="form-group">
											<label for="exampleInputEmail1"><h4>
													尊敬的${sessionScope.manager.man_name}
													${sessionScope.manager.man_range}</br>您好
												</h4></label>
										</div>

										<div class="form-group">
											<label for="exampleInputPassword1"><h4>
													您的登录名为</br>${sessionScope.manager.man_loginname}</h4></label>
										</div>

										<div class="form-group">
											<label for="exampleInputPassword1"><h4>
													您的id为</br>${sessionScope.manager.man_id}</h4></label>
										</div>
					...
					<div style="width: 1000px; height: 800px; margin-left: 320px;">
						...
						<div
							style="overflow-y: auto; overflow-x: auto; width: 400px; height: 580px; float: left">

							<c:forEach items="${Notes}" var="note">
								<input type="hidden" value="${note.note_id}" id="idHere">
								<ul style="position: relative; border-bottom: 1px dotted black;">
									<li>发布者Id：${note.user_id}</li>
									<li>笔记名称：${note.note_name} <input
										style="position: absolute; left: 270px; top: 15px;"
										type="button" onclick="getNote(this)" name="${note.note_id}"
										value="查看">
									</li>
								...
								$
										.ajax({
											...
											success : function(data) {
												document
														.getElementById("noteDetail").innerHTML = data;
											},
											error : function() {
												alert("wrong!");
											},
						...
						<div id="noteDetail"
							style="overflow-y: auto; overflow-x: auto; width: 500px; height: 580px; margin-left: 425px; position: relative">
						</div>
